...
int main(int argc, char **argv) {
...

    {
        ...
        auto timeStepper =
            ablate::solver::TimeStepper(domain, ablate::parameters::MapParameters::Create({{"ts_adapt_type", "physicsConstrained"}, {"ts_max_steps", "600"}, {"ts_dt", "0.00000625"}}), {}, {initialCondition});
